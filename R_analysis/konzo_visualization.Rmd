...
### I commented out the old way that had some errors. But kept for personal reference, until I spend time updating this later - KMG.
...
# New way from BNN to use taxonimzer to get taxonomic info from NCBI easier.
